...
//		Vector3 selectedDifference = m_RectTransform.localPosition - m_SelectedRectTransform.localPosition;
		...
		float above = currentScrollRectPosition - ( m_SelectedRectTransform.rect.height / 2f ) + m_RectTransform.rect.height;
		float below = currentScrollRectPosition + ( m_SelectedRectTransform.rect.height / 2f );
